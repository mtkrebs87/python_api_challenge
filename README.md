...
Like before, one of my biggest struggles with this challenge was linear regression. However, I think this time I've gotten a much better understanding of the code. Practice makes perfect!
Another issue I came across was getting a 401 error with my GeoApify API code. I regenerated three different codes and came up with the same issue.

Resources for this project:

https://www.youtube.com/watch?v=79c8rw4dHV8

https://github.com/theodoremoreland/WeatherPy/blob/master/WeatherPy.py

https://github.com/philipstubbs13/python-api-challenge/blob/master/VacationPy/VacationPy.ipynb
